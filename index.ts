...
/*
Generics ya ak tarika ha jis sa ap datatype ko bi control kar sakta ho
...
console.log(gen<string>("shakeeb","anwar"))
console.log(gen<number>(1,2))
console.log(gen<Array<number>>([1],[3])) //yaha humna array ka sath number ki datatype isliya li q ka array khud generic ha tu huma array ka sath batana bi parha ga ka array ma number honga ya string




function addUser<T extends {id:string}>(user:T){ // extends ka keyword sa honga ya ka user ka andar sa mujhe id excess pa error daga lakin extend ki waja sa nhi daga

    return user.id
}


//any type(jb hum datatype ko define nhi karaga tu bydefault wo sb datatype ko accecpt karaga aur iska bilkol opposite ha never type jo kuch bi accept nhi karta)
